...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            '--fineSize', type=str, default='2048,1536', help='then crop to this size')
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            '--guide_complexity', type=int, default=16, help='guideNN filter number')
        self.parser.add_argument(
            '--downsample', type=float, default=1/8, help='downsample rate')
    ...
    def parse(self):
        ...
        self.opt.git_tag = util.get_current_git_tag()
        if self.opt.git_tag:
            print("Current Git Tag:", self.opt.git_tag)
        else:
            print("No tag found or not a Git repository.")
