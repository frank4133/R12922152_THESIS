...
class TSMEF5(nn.Module):
    def __init__(self, opt, stage1_model_path=r"./checkpoints/HeMEF/07-22-15-12/500/HeMEF.pth"):
        super(TSMEF5, self).__init__()
    ...
    def load_stage1_model(self):
        ...
        self.stage1_model = HeMEF(self.opt)
    ...
    def forward(self, x1, x3):
        ...
        """
        with torch.no_grad():
            x2, _ = self.stage1_model.forward(x1, x3)
