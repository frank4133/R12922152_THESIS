...
class EvidenceHead(nn.Module):
    ...
    def __init__(self, in_ch):
        super().__init__()
        self.econv = nn.Conv2d(in_ch, 3, kernel_size=1, bias=True)
...
class HeMEF3(nn.Module):
    def __init__(self, opt):
        super(HeMEF3, self).__init__()
        filters_in = 3
        filters_out = 3
        nFeat = 32
    ...
    def forward(self, x1, x2, x3):
        ...
        E3 = self.activation(self.conv3(x3))
        E3_0 = self.activation(self.conv3_E0_1(E3))
        ...
        E3_1 = self.activation(self.conv3_E1_1(E3_0))
        ...
        E3_2 = self.activation(self.conv3_E2_1(E3_1))
        ...
        E3_3 = self.activation(self.conv3_E3_1(E3_2))
        ...
        D2 = self.activation(self.conv_D2_1(torch.cat([D3_cropped, E1_2, E2_2, E3_2], dim=1)))
        D2 = self.conv_D2_2(D2)
        # print(f"D2: {D2.shape}")
        D1 = self.activation(self.conv_D1_1(torch.cat([D2, E1_1, E2_1, E3_1], dim=1)))
        D1 = self.conv_D1_2(D1)
        # print(f"D1: {D1.shape}")
        D0 = self.activation(self.conv_D0_1(torch.cat([D1, E1_0, E2_0, E3_0], dim=1)))
        D0 = self.conv_D0_2(D0)
        # print(f"D0: {D0.shape}")
        D = self.activation(self.conv_D_1(torch.cat([D0, E1, E2, E3], dim=1)))
        D = self.conv_D_2(D)
        # print(f"D: {D.shape}")
