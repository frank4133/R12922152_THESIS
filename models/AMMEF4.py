...
import numpy as np
import torch
from .AttnMerger2 import HierarchicalCrossAttentionFusion
...
class AMMEF4(nn.Module):
    def __init__(self, opt):
        super(AMMEF4, self).__init__()
        filters_in = 3
        filters_out = 3
        nFeat = 32
        ...
        # merge
        self.merger = HierarchicalCrossAttentionFusion(dim=nFeat * 8, num_heads=4)
