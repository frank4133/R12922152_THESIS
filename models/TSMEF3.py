...
class TSMEF3(nn.Module):
    def __init__(self, opt, stage1_model_path=None):
        super(TSMEF3, self).__init__()
        ...
        growthRate = 32
        self.opt = opt
        self.stage1_model = HybridMEF(opt)
    ...
    def load_stage1_model(self):
        ...
        if self.stage1_model_path is not None:
            self.stage1_model = HybridMEF(self.opt)
    ...
    def forward(self, x1, x3):
        ...
        output = torch.sigmoid(output) + x2
