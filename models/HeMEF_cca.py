...
class HeMEF_cca(nn.Module):
    def __init__(self, opt):
        super(HeMEF_cca, self).__init__()
        filters_in = 3
        filters_out = 3
        nFeat = 32
